...
/*   Updated: 2023/03/06 12:13:22 by yoel-idr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_short get_mode(int x, int y, t_short flag)
{
     ...
     * @brief SETTING PAGES
     */
    ret = (x > 1123 && x < 1200 && y >= 0 && y <= 360) * BACK + \
     ...
     */
    ret = (x > 1123 && x < 1200 && y >= 0 && y <= 360) * TEXT1 + \
     ...
     * @brief GAME PAGE
     */
    ret = (x > 1123 && x < 1200 && y >= 0 && y <= 360) * G_PAUSE + \
          (x > 1123 && x < 1200 && y >= 0 && y <= 360) * MOVE_RIGHT + \
          (x > 1123 && x < 1200 && y >= 0 && y <= 360) * MOVE_LEFT;
    /**
     * @brief G_PAUSE PAGES
     */
    ret = (x > 1123 && x < 1200 && y >= 0 && y <= 360) * RESUME + \

...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/14 09:23:37 by yoel-idr          #+#    #+#             */
/*   Updated: 2023/03/18 23:47:14 by yoel-idr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "leet3d.h"

static t_short	p_game(int x, int y)
{
	t_short	butt;
...
static t_short	graphics_button(t_flag flag, int x, int y)
{
	...
	if (flag & MAPS)
	{
		butt = (x > 413 && x < 854 && y > 0 && y < 447) * MAP1 + \
			(x > 855 && x < 1279 && y > 0 && y < 447) * MAP2 + \
			(x > 413 && x < 854 && y > 449 && y < 719) * MAP3 + \
			(x > 855 && x < 1279 && y > 449 && y < 719) * MAP4 + \
			(x > 20 && x < 200 && y > 646 && y < 699) * BACK;
		return (butt);
	}
	butt = (x > 413 && x < 854 && y > 0 && y < 447) * TEXT1 + \
		(x > 855 && x < 1279 && y > 0 && y < 447) * TEXT2 + \
		(x > 413 && x < 854 && y > 449 && y < 719) * TEXT3 + \
		(x > 855 && x < 1279 && y > 449 && y < 719) * TEXT4 + \
		(x > 20 && x < 200 && y > 646 && y < 699) * BACK;
	return (butt);
}

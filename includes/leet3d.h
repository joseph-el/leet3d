...
typedef enum s_select
{
	...
	SET_VOLUME = (UVOLUME | DVOLUME | MVOLUME |
					EVOLUME | MSOUND | ESOUND | MSFX | ESFX)
}							t_select;
...
void						set_(t_minimap *leet, char ***map, int *ret,
								int flag);
...
t_vector					get_vertical_intercept(t_leet *leet, \
						double rayAngle);
t_vector					get_horizontal_intercept(t_leet *leet, \
						double rayAngle);
...
void						render_wall(t_leet *leet, int top, int bottom,
								int i);
void						wall_collisions(t_leet *leet, double angle,
								int sign);
void						ft_mlx_pixel_put(t_img *data, int x, int y,
								int color);
void						put_pixel(t_img *src, int width, int height,
								int color);
void						draw_square(t_img *img, int s_x, int s_y,
								unsigned int color);
void						vertical_render(t_leet *leet, int i, int top,
								t_vector offset);
void						horizontal_render(t_leet *leet, int i, int top,
								t_vector offset);
...
void						mouse_button(int button, int x, int y,
								t_leet *leet);
